...
UnkStruct_ov42_02228EDC* ov42_02228EDC(SpriteList* arg0, PaletteData* arg1, u16 arg2, s8 arg3, enum HeapID arg4) {
...
UnkStruct_ov42_02228EDC* ov42_02228F24(SpriteList* arg0, PaletteData* arg1, u16 arg2, s32 arg3, s32 arg4, s32 arg5, enum HeapID arg6) {
...
void ov42_02228FE0(UnkStruct_ov42_02228EDC* arg0, s32 arg1, s32 arg2, enum HeapID arg3) {
    if (ov42_022271E4(arg0->unk0, arg1) == 0) {
        ov42_02227194(arg0->unk0, arg1, arg0->unkB, arg2, arg3);
    }
}
...
void ov42_02229028(UnkStruct_ov42_02228EDC* arg0, s32 arg1, enum HeapID arg2) {
    ov42_02227228(arg0->unk0, arg0->unkB, arg1, arg2);
}

UnkStruct_ov42_0222903C* ov42_0222903C(UnkStruct_ov42_02228EDC* arg0, UnkStruct_ov42_02228110* arg1, u32 arg2, enum HeapID arg3) {
    ...
    sp4[3] = arg0->unkA;
    temp_r4->unk4 = ov42_022272BC(arg0->unk0, sp4, ov42_02228188(arg1, 7), arg3);
...
UnkStruct_ov42_022293B8* ov42_022293B8(G2dRenderer* arg0, BgConfig* arg1, u8* arg2, enum HeapID heapID) {
...
void ov42_02229514(BgConfig* arg0, s32 arg1, u8* arg2) {
    ...
    FreeBgTilemapBuffer(arg0, arg1);
    InitBgFromTemplate(arg0, arg1, &bgTemplate, 0);
}
...
void ov42_02229570(UnkStruct_ov42_022293B8* arg0, s16 arg1, s16 arg2) {
    ...
    if ((temp_r3 != arg0->unk18) || (temp_r0 != arg0->unk1A)) {
        arg0->unk18 = temp_r3;
        arg0->unk1A = temp_r0;
        ov42_02229600(arg0->unk4, arg0->unk14, arg0->unkC, -temp_r3, -temp_r0);
        ScheduleBgTilemapBufferTransfer(arg0->unk4, arg0->unk14);
    }
    ScheduleSetBgPosText(arg0->unk4, arg0->unk14, BG_POS_OP_SET_X, temp_r6);
    ScheduleSetBgPosText(arg0->unk4, arg0->unk14, BG_POS_OP_SET_Y, temp_r4_3);
}

void ov42_02229600(BgConfig* arg0, s32 arg1, NNSG2dScreenData* arg2, s16 arg3, s16 arg4) {
    s16 sp34 = arg2->screenWidth / 8;
    s16 sp30 = arg2->screenHeight / 8;
...
void ov42_022296F0(BgConfig* arg0, u8 arg1, u8 arg2, u8 arg3, u8 arg4, u8 arg5, void* arg6, u8 arg7, u8 arg8, u8 arg9, u8 argA) {
    s8 sp48;
    s8 sp44;
    u8 sp40 = ov42_02229880(arg9, argA);
    if (sp40 == 0) {
        CopyToBgTilemapRect(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, argA);
        return;
    }
    sp48 = arg5;
    while (sp48 > 0) {
        ...
        while (r4 > 0) {
            ...
            CopyToBgTilemapRect(arg0, arg1, r7, arg3, r6, sp44, temp, r5 % 32, sp4C, sp4.unk0, sp4.unk2);
            r5 += r6;
            r7 += r6;
        }
        arg8 += sp44;
...
UnkStruct_ov42_02229A40* ov42_02229974(s32 arg0, enum HeapID arg1) {
    UnkStruct_ov42_02229A40* temp_r0 = Heap_Alloc(arg1, sizeof(UnkStruct_ov42_02229A40));
    GF_ASSERT(temp_r0);
    s32 temp_r1 = arg0 + 1;
    temp_r0->unk4 = temp_r1;
    void* temp_r0_2 = Heap_Alloc(arg1, temp_r1 * 8);
...
UnkStruct_ov42_02229A40* ov42_02229A40(s32 arg0, enum HeapID arg1) {
    UnkStruct_ov42_02229A40* temp_r0 = Heap_Alloc(arg1, sizeof(UnkStruct_ov42_02229A40));
    GF_ASSERT(temp_r0);
    temp_r0->unk4 = arg0 + 1;
    temp_r0->unk0 = Heap_Alloc(arg1, (arg0 + 1) * 4);
